...
const Facebook = ({ TabTitle }) => {
  ...
  return (
    <div className="facebook_listing">
      <div className="facebook_listing_wrapper">
        <Box>{TabTitle}</Box>
        ...
        <FormControl fullWidth sx={{ pt: 3 }}>
          ...
          <Select
            ...
            variant="filled"
            onChange={HandleChangeFacebookType}
          >
            <MenuItem value={1}>Group</MenuItem>
            <MenuItem value={2}>Page</MenuItem>
            <MenuItem value={3}>Profile</MenuItem>
          </Select>
        </FormControl>
        <FormControl fullWidth sx={{ pt: 3 }}>
        ...
        <FormControl fullWidth sx={{ pt: 3 }}>
          <FormLabel>Monetize Check Mark</FormLabel>
          <Select
            labelId="demo-simple-select-label"
            id="demo-simple-select"
            value={MonetizeCheckMark}
            label="Waring"
            variant="filled"
            onChange={HandleChangeMonetizeCheckMark}
          >
            <MenuItem value={1}>start</MenuItem>
            <MenuItem value={2}>In Stream Ads</MenuItem>
            <MenuItem value={3}>Ads On Reels</MenuItem>
            <MenuItem value={4}>Bonus</MenuItem>
            <MenuItem value={5}>Live Ads</MenuItem>
