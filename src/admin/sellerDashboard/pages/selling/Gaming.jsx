...
const Gaming = ({ TabTitle }) => {
  ...
  return (
    <div className="telegram_listing">
      <div className="telegram_listing_wrapper">
        <Box>{TabTitle}</Box>
        ...
        <FormControl fullWidth sx={{ pt: 3 }}>
          ...
          >
            <MenuItem value={1}>Free Fire</MenuItem>
            <MenuItem value={1}>BGMI</MenuItem>
            <MenuItem value={1}>Clash of clan</MenuItem>
          </Select>
        </FormControl>
        <FormControl fullWidth sx={{ pt: 3 }}>
